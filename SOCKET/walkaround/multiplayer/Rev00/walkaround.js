class Game{
    constructor(){
        ...
        this.modes = Object.freeze({
            ...
            INITIALISING: Symbol("initalising"),
            CREATING_LEVEL: Symbol("creating_level"),
            ACTIVE: Symbol("active"),
            GAMEOVER: Symbol("gamover")
        });
        ...
        // options.assets.push(`${game.assetsPath}ifc/RAC_basic_sample_project.ifc`);
        options.assets.push(`${game.assetsPath}ifc/town.fbx`);
    ...
    init(){
        ...
        // ifcLoader.ifcManager.setWasmPath('../../walkaround/libs/');
        ...
        // LOAD ENVIRONMENT 
        this.loadEnvironment(loader, ifcLoader);
    ...
    loadEnvironment(loader, ifcLoader){
        // const game = this;
        // ifcLoader.load('../assets/ifc/RAC_basic_sample_project.ifc', function(model){
        //     // scene.add(model.mesh);
        //     game.environment = model;
        //     game.colliders = [];
        //     game.scene.add(model.mesh);
        ...
        // })
        const game = this;
		loader.load(`${this.assetsPath}ifc/town.fbx`, function(object){
    ...
    showMessage(msg, fontSize = 18, onOK = null){
