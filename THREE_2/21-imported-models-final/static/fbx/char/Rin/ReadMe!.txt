...
***To Use VRChat-ready package: Create a fresh unity project in unity 2018.4.20f1. Import the vrc sdk and the dynamic bone
...
VRC SDK: VRC SDK can be downloaded from the official vrchat site. Please import vrc sdk 2.0 or 3.0 depending upon the package
avatar version.
