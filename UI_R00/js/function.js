...
$(document).ready(function(){
	...
	$('.show').on('click',function(){
		if(show===1){
			...
			$('.BIMTech-Body').addClass("BIMTech-Body-2");
			show = 0;
		}else{
			$('.menuleft').removeClass("menuleft2");
			$('.BIMTech-Body').removeClass("BIMTech-Body-2");
			show = 1;
		}
	});
	//DOWNLOADS
	...
	$('.menuClick').click(function(){
		if(menuLeft === 1){
			$('.Menu-Left').addClass("Menu-Left-2");
			menuLeft = 0;
		}else{
			$('.Menu-Left').removeClass("Menu-Left-2");
			menuLeft = 1;
		}
	});
	// Stars Hover
	$('.two-stars').hover(function(){
		$(this).addClass('one-star-hover');
	});
});
